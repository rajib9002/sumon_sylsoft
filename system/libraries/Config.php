...
define("AUTHORIZENET_API_LOGIN_ID","9H4Dg8sk");    // Add your API LOGIN ID
define("AUTHORIZENET_TRANSACTION_KEY","3VVXxM9t32729z9E"); // Add your API transaction key
...
$site_root = "http://localhost/zafran_new/"; // Add the URL to your site
