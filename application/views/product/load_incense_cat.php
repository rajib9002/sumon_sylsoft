...
<tr class="odd">
<td align="left"><a style="text-decoration:none;" href="<?php echo site_url('product/brand_list/'.$sub_cat_list['id'])?>"><div style="padding:5px 20px;text-align: left;font-size: 14px;color:#000;text-decoration: none;"><?php echo $i?>. &nbsp;<?php echo $sub_cat_list['category_name'];?></div></a></td>
</tr>
<?$i=$i+1;?>
<?php }?>
</table>
