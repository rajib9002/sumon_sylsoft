...
class admin extends Controller {
    ...
    function index(){
        ...
        if ($_POST['search_admin']) {
            $gridObj->setGridOptions("Admin Info", 880, 200, "user_id", "desc", $gridColumn, $gridColumnModel, site_url("?c=admin&m=load_admin&name={$_POST['name']}&status={$_POST['status']}"), true);
        } else {
