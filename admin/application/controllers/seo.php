...
class seo extends Controller{
    ...
    function add_seo(){
        ...
        $data['nav_array'] = array(
            array('title' =>"Add New Seo", 'url' => site_url('seo/add_seo')),
            array('title' =>"Add New Seo", 'url' => '')
        );
        //$this->session->unset_userdata('edit_success_id'); //Don't Change
        $data['msg'] = $this->session->flashdata('msg');
        $data['dir'] = 'seo';
        $data['page'] = 'add_seo'; //Don't Change
        $data['page_title'] = "Add New Seo";
    ...
    function edit_seo($id){
       ...
       $data = sql::row('seo', "id='$id'");
        ...
        $data['nav_array'] = array(
            array('title' =>"Seo", 'url' => site_url('seo')),
            array('title' => "Edit Seo", 'url' => '')
        );
    ...
    function delete_seo($id){
       ...
       $this->session->set_flashdata('msg',"Seo deleted successfully");
        redirect('seo');
    }
