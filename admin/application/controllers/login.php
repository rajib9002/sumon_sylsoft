    ...
    function forgot_password() {
        if ($_POST['send']) {
            if ($this->form_validation->run('valid_forgot_password')) {
                ...
                $this->session->set_flashdata('msg', 'Thank you for contacting Zafran Perfumes Online Account Support.<p>We have Sent you an email to ' . $_POST['email'] . ' .
                                                    <span class="block">Please check your email- a password reset link will be included in a message from sweettopup. Please click on the link to complete your password reset Process.</span></p>
                                                    <br />Thank you,
