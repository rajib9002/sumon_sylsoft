        ...
        <table id="add_image">
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type='text' class="text ui-widget-content ui-corner-all width_200  required" name='category_name' value="<?=set_value('category_name')?>" /><?=form_error('category_name','<span>','</span>')?></td>
                </tr>
               <tr>
                   <th>&nbsp;</th>
