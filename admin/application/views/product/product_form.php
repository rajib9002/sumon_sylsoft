...
function add_more_products(){
                var new_products="<tr>"+
                    ...
                    "<td><input type='text' class='text ui-widget-content ui-corner-all width_80 number price_"+inc+"'name='price[]'/></td>"+
                    "<td><input type='text' class='text ui-widget-content ui-corner-all width_80 number quantity_"+inc+"' autocomplete='off' onkeyup='javascript:item_calculation.price_quantity("+inc+")'  name='quantity[]'  /></td>"+
...
<div class="form_content"style="width:880px;">
    <div class="ui-jqdialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix form_title">
     ...
     <form id="valid_form" class="sale_form" method='post' action='<?=site_url('product/add_product');?>' enctype="multipart/form-data">
...
<tr>
                        ...
                        <td>
                            <input type="radio" name="pro_type" value="1" checked="checked"> Ordinary
...
<table id="product"  width="100%" border="0" style="margin:0;background-color:#fff;">
    <tbody>
        ...
        <tr>
            <td><input type='text' class="text ui-widget-content ui-corner-all width_80   size_<?=$inc ?> "  name='size[]' value="<?=$pro['pr_quantity']?>"/>
            <input type="hidden" name="pro_serial[]" value="" id="pr_serial_<?= $inc ?>"/>
            </td>
            <td><input type='text' class="text ui-widget-content ui-corner-all width_80  unit_<?=$inc ?> " name='unit[]' value="<?=$_REQUEST['unit'][$inc]?>" /></td>
             <td><input type='text' class="text ui-widget-content ui-corner-all width_80  unit_<?=$inc ?> " name='weight[]' value="<?=$_REQUEST['weight'][$inc]?>" /></td>
            <td><input type='text' class="text ui-widget-content ui-corner-all width_80  price_<?=$inc ?> " name='price[]' value="<?=$_REQUEST['price'][$inc]?>" /></td>
            <td><input type='text' class="text ui-widget-content ui-corner-all width_80  quantity_<?=$inc ?>"name='quantity[]' value="<?=$_REQUEST['quantity'][$inc]?>" /></td>
            <td><input type='text' class="text ui-widget-content ui-corner-all width_80  color_<?=$inc ?>"name='color[]' value="<?=$_REQUEST['color'][$inc]?>" /></td>
            <td><input type='text' class="text ui-widget-content ui-corner-all width_80  designer_<?=$inc ?>"name='designer[]' value="<?=$_REQUEST['designer'][$inc]?>" /></td>
